...
Neosiki/korean-humanize v8 설계 확장과 v5.0.0 기준선 실증에 대한 탐색적 아티팩트 연구
...
본 연구는 공개 저장소 Neosiki/korean-humanize v5.0.0을 기준선 아티팩트로 보고
...
본 연구는 Neosiki/korean-humanize v5.0.0을 한국어 윤문을 위한 기준선 소프트웨어 아티팩트로 보고
