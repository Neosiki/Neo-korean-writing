"""Neo Korean Writing v2.0 quantitative metrics calculator.
...
`.claude/skills/neo-korean-writingrean/references/`.
...
def _main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Neo Korean Writing v2.0 metric runner")
